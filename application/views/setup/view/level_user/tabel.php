...
<a onclick="reload_tabel();" class="btn btn-warning pull-right"> Refresh </a>
<hr>
<?php get_pesan('msg'); ?>
<style>
...
<?php $this->load->view("$urlnya/form"); ?>
<?php $this->load->view("$urlnya/detail"); ?>
<?php $this->load->view("$urlnya/ajax"); ?>
